...
export const CREAT_EVENT_REQUEST = "CREAT_EVENT_REQUEST";
export const CREAT_EVENT_SUCCESS = "CREAT_EVENT_SUCCESS";
export const CREAT_EVENT_FAILURE = "CREAT_EVENT_FAILURE";